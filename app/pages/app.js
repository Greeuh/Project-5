          ...
          <div class="tw-block-parent">
            <div class="timeline-TweetList-tweet">
              <div class="timeline-Tweet">
                ...
                <div class="timeline-Tweet-metadata"><a href={'https://twitter.com/' + result.user.name + '/status/' + result.id}><span class="timeline-Tweet-timestamp">{result.created_at}</span></a></div>
